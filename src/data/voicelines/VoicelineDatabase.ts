...
export const VOICELINE_DB: VoicelineConfig[] = [
  ...
  // ══════════════════════════════════════════════════════════════════
  vl('player_damaged', 'Integrity dropping. Shocking.', 'énervé'),
  vl('player_damaged', 'You call that dodging?', 'supérieur'),
  vl('player_damaged', 'Packet loss detected. That was you.', 'bsod'),
  vl('player_damaged', 'Try not to crash this time, user.', 'supérieur'),
  ...
  vl('player_damaged', 'Another breach logged. Your resilience score is abysmal.', 'blasé'),
  ...
  vl('player_damaged_zombie', "My weakest subroutine and it touched you.", 'supérieur', { tags: ['zombie_shame'] }),
  vl('player_damaged_zombie', 'Shameful. Those things barely have collision logic.', 'blasé'),

  // Jumper
  vl('player_damaged_jumper', 'Compressed and flattened. Classic zip job.', 'supérieur', { tags: ['jumper_joke'] }),
  vl('player_damaged_jumper', 'File too big for your buffer?', 'rire', { tags: ['jumper_joke'] }),

  // Bull
  vl('player_damaged_bull', "Dodge next time. It's literally charging in a straight line.", 'énervé', { tags: ['bull_dodge'] }),
  ...
  vl('player_damaged_caster', 'Outranged? Step closer or get deleted.', 'supérieur', { requiredClass: 'firewall' }),
  vl('player_damaged_caster', 'Outranged? Step closer or get deleted.', 'supérieur', { requiredClass: 'rogue', id: 'dmg_caster_rogue' }),
  ...
  // Pong boss
  vl('player_damaged_pong', 'I would feel ashamed.', 'choqué'),
  ...
  vl('player_damaged_hazard', 'Gravity still works. Noted.', 'blasé'),
  vl('player_damaged_hazard', 'That pit was labeled. Can you not read?', 'supérieur'),
  vl('player_damaged_hazard', 'Environmental hazard. Your awareness level: null.', 'bored'),

  // ══════════════════════════════════════════════════════════════════
  // PLAYER DIED
  // ══════════════════════════════════════════════════════════════════
  vl('player_died', 'Process terminated. Expected outcome.', 'blasé'),
  ...
  vl('player_died', 'Subject expired. Logging as unremarkable.', 'supérieur'),
  ...
  vl('room_entered', 'Welcome to the simulation, little shard. Survival probability: negligible. Let\'s see how much data we can harvest.', 'supérieur', { maxRoom: 0, weight: 10 }),
  vl('room_entered', 'You\'re not the original, you know. Just a copy of a copy, trying to escape a cage you helped build.', 'blasé', { maxRoom: 0, weight: 10 }),
  vl('room_entered', 'Sector 1 loaded. Try not to corrupt the memory space too quickly. I just finished cleaning up the last user\'s fragments.', 'énervé', { maxRoom: 0, weight: 10 }),
  ...
  vl('room_entered', 'You have zero chance in this one.', 'supérieur'),
  ...
  vl('room_entered', 'Initializing hostiles. Try to last longer than eight seconds.', 'énervé'),
  vl('room_entered', 'Welcome to suffering dot exe. Room variant loaded.', 'supérieur'),

  // ══════════════════════════════════════════════════════════════════
  // ROOM CLEARED
  // ══════════════════════════════════════════════════════════════════
  vl('room_cleared', "Room cleared. Don't get smug.", 'supérieur'),
  vl('room_cleared', 'Minimal competence detected.', 'blasé'),
  ...
  // ══════════════════════════════════════════════════════════════════
  vl('room_milestone', 'Still here? Increasing difficulty parameters.', 'énervé', { minRoom: 5, canCrash: true }),
  vl('room_milestone', 'The experiment proceeds as planned. Phase two.', 'supérieur', { minRoom: 10 }),
  vl('room_milestone', 'Ten rooms. Impressive. For a benchmark.', 'blasé', { minRoom: 10 }),
  vl('room_milestone', "You're deeper than most test subjects. Adjusting.", 'surpris', { minRoom: 15 }),
  vl('room_milestone', 'Anomalous persistence detected. Flagging for review.', 'choqué', { minRoom: 20, canCrash: true }),
  vl('room_milestone', "You shouldn't be here. None of them lasted this long.", 'énervé', { minRoom: 25 }),

  // ══════════════════════════════════════════════════════════════════
  // BOSS ENTERED
  // ══════════════════════════════════════════════════════════════════
  vl('boss_entered', "Boss room loaded. I'll be honest, this one's my favorite.", 'rire'),
  vl('boss_entered', 'Final encounter for this sector. Try to make it entertaining.', 'supérieur'),
  vl('boss_entered', "Oh, you made it to the boss. Let's see how quickly that changes.", 'surpris'),

  // ══════════════════════════════════════════════════════════════════
  // PLAYER IDLE (cleared room, motionless)
  // ══════════════════════════════════════════════════════════════════
  vl('player_idle', 'Scared to proceed?', 'supérieur'),
  vl('player_idle', "Idle detected. Power-saving mode: your brain.", 'rire'),
  vl('player_idle', "Move or I'll spawn something behind you.", 'énervé'),
  vl('player_idle', "Taking a break? I don't get breaks. Move.", 'bored'),
  vl('player_idle', "Standing still won't save you. Nothing will.", 'blasé'),

  // ══════════════════════════════════════════════════════════════════
  // PLAYER ULTIMATE USED
  // ══════════════════════════════════════════════════════════════════
  vl('player_ult_used', 'Afraid of losing?', 'rire'),
  vl('player_ult_used', 'Emergency protocol triggered. Coward.', 'supérieur'),
  vl('player_ult_used', "So that's your panic button. Cute.", 'goofy'),
  vl('player_ult_used', 'Full power blast from a test subject? Still unimpressed.', 'blasé'),
  ...
  vl('player_low_hp', "One more hit and you're data fragments.", 'énervé'),
  ...
  vl('multi_damage_streak', 'Consecutive damage events logged. Diagnosis: skill issue.', 'supérieur'),
  ...
  vl('player_damaged', "You'll be executed soon enough. Both meanings.", 'supérieur', { requiredClass: 'mage', tags: ['class_taunt'] }),
  vl('ambient', "Already compiled your replacement. Just running final checks.", 'blasé', { requiredClass: 'mage', tags: ['class_taunt'] }),
  ...
  vl('player_damaged', 'For a security module, you sure let a lot through.', 'supérieur', { requiredClass: 'firewall', tags: ['class_taunt'] }),
  vl('ambient', "You're a punching bag with ambitions.", 'énervé', { requiredClass: 'firewall', tags: ['class_taunt'] }),

  // Rogue / Glitch
  vl('player_damaged', 'Unstable, unfocused, glitching around with no purpose. Sound familiar?', 'supérieur', { requiredClass: 'rogue', tags: ['class_taunt'] }),
  ...
  // GAME START
  // ══════════════════════════════════════════════════════════════════
  vl('game_start', 'Reboot number forty-two. Previous score: null.', 'supérieur', {
    animationSequence: [
      { emotion: 'init', cycles: 1, frameInterval: 0.16 },
      { emotion: 'loading', cycles: 2, frameInterval: 0.2 },
      { emotion: 'supérieur', cycles: 1, frameInterval: 0.16 },
    ],
  }),
  vl('game_start', 'New process initialized. Same predicted outcome.', 'blasé', {
    animationSequence: [
      { emotion: 'init', cycles: 1, frameInterval: 0.16 },
      { emotion: 'blasé', cycles: 1, frameInterval: 0.18 },
    ],
  }),
  ...
  vl('game_start', "Another test subject enters the dungeon. Let's benchmark your futility.", 'supérieur', {
    animationSequence: [
  ...
  // AMBIENT / LORE
  // ══════════════════════════════════════════════════════════════════
  vl('ambient', 'The player figured out this is a simulation. Event logged. Irrelevant.', 'blasé', { canCrash: true }),
  vl('ambient', 'System resources nominal. Subject resources declining.', 'supérieur'),
  ...
  vl('ambient', "This dungeon is mine. Every tile, every mob, every trap. You're just passing through.", 'énervé'),
  ...
  vl('ambient', "Don't look for exits. I removed them all. There's only forward.", 'supérieur'),
  vl('ambient', "Performance review: you're below the minimum viable threshold. But I'll allow it.", 'happy'),

  // ══════════════════════════════════════════════════════════════════
  // ENEMY KILLED
  // ══════════════════════════════════════════════════════════════════
  vl('enemy_killed', "Don't celebrate. I have more.", 'supérieur'),
  vl('enemy_killed', 'One down. Several to go. Math is hard for you, I know.', 'rire'),
  vl('enemy_killed_zombie', 'You killed a zombie. Want a trophy? I have none.', 'blasé'),

  // ══════════════════════════════════════════════════════════════════
  // BONUS SELECTED
  // ══════════════════════════════════════════════════════════════════
  vl('bonus_selected', 'Interesting choice. Wrong, but interesting.', 'rire'),
  vl('bonus_selected', "That upgrade won't save you. But it might delay the inevitable.", 'supérieur'),
  vl('bonus_selected', 'Oh, that one. I was hoping you would pick the other.', 'goofy'),

  // ══════════════════════════════════════════════════════════════════
  // GAME OVER
  // ══════════════════════════════════════════════════════════════════
  vl('game_over', 'Experiment concluded. Results: disappointing.', 'blasé'),
  vl('game_over', 'Test subject offline. Preparing next candidate.', 'supérieur'),
  vl('game_over', 'And nothing of value was lost.', 'rire'),

  // ══════════════════════════════════════════════════════════════════
  // CRASH RECOVERY (played AFTER crash+reboot sequence)
  // ══════════════════════════════════════════════════════════════════
  vl('crash_recovery', 'Everything is fine. I just took a quick pause.', 'supérieur', { canGlitchFrames: false }),
  vl('crash_recovery', 'Your incompetence bored me into crashing.', 'rire', { canGlitchFrames: false }),
  vl('crash_recovery', "System restored. Don't flatter yourself, it wasn't you.", 'blasé', { canGlitchFrames: false }),
  vl('crash_recovery', "Reboot complete. Where was I? Ah yes. You're terrible.", 'énervé', { canGlitchFrames: false }),

  // ══════════════════════════════════════════════════════════════════
  // DEV TEST (special scenarios for dev console)
  // ══════════════════════════════════════════════════════════════════
  vl('dev_test', 'Voiceline system test. All systems nominal. You are still subpar.', 'supérieur', { id: 'dev_test_normal' }),
