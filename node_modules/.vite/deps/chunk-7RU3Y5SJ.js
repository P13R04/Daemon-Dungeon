...
Node.AddNodeConstructor("TargetCamera", (name48, scene) => {
  return () => new TargetCamera(name48, Vector3.Zero(), scene);
});
...
var DracoCompression = class _DracoCompression {
   ...
   */
  async decodeMeshToGeometryAsync(name48, scene, data, attributes) {
  ...
  /** @internal */
  async _decodeMeshToGeometryForGltfAsync(name48, scene, data, attributes, gltfNormalizedOverride) {
...
//# sourceMappingURL=chunk-7RU3Y5SJ.js.map
