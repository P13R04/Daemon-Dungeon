...
const rooms = [
  {
    ...
    spawnPoints: [
      ...
      // Added Horde
      { x: 2, y: 1, enemyType: "fuyard" },
      { x: 12, y: 1, enemyType: "fuyard" },
      { x: 3, y: 1, enemyType: "prefire_sentinel" },
      { x: 11, y: 1, enemyType: "prefire_sentinel" },
      { x: 5, y: 3, enemyType: "healer" },
      { x: 9, y: 3, enemyType: "healer" },
      { x: 3, y: 5, enemyType: "zombie_fast" },
      { x: 11, y: 5, enemyType: "zombie_fast" },
      { x: 5, y: 5, enemyType: "prefire_sentinel" },
      { x: 9, y: 5, enemyType: "healer" },
      { x: 7, y: 7, enemyType: "bullet_hell" },
      { x: 3, y: 7, enemyType: "bull" },
      { x: 11, y: 7, enemyType: "bull" },
      { x: 3, y: 13, enemyType: "zombie_fast" },
      { x: 11, y: 13, enemyType: "zombie_fast" },
      { x: 5, y: 13, enemyType: "fuyard" }
    ]
  },
  {
    ...
    spawnPoints: [
      ...
      // Added Horde
      { x: 4, y: 7, enemyType: "bullet_hell" },
      { x: 10, y: 7, enemyType: "bullet_hell" },
      { x: 7, y: 7, enemyType: "bullet_hell" },
      { x: 5, y: 3, enemyType: "healer" },
      { x: 9, y: 3, enemyType: "healer" },
      { x: 5, y: 7, enemyType: "prefire_sentinel" },
      { x: 9, y: 7, enemyType: "prefire_sentinel" },
      { x: 1, y: 11, enemyType: "zombie_fast" },
      { x: 13, y: 11, enemyType: "zombie_fast" },
      { x: 3, y: 13, enemyType: "zombie_fast" },
      { x: 11, y: 13, enemyType: "zombie_fast" },
      { x: 2, y: 1, enemyType: "bull" },
      { x: 12, y: 1, enemyType: "bull" }
    ]
  },
  {
    ...
    spawnPoints: [
      ...
      // Added Horde
      { x: 6, y: 4, enemyType: "prefire_sentinel" },
      { x: 8, y: 4, enemyType: "prefire_sentinel" },
      { x: 5, y: 7, enemyType: "artificer" },
      { x: 9, y: 7, enemyType: "artificer" },
      { x: 6, y: 8, enemyType: "prefire_sentinel" },
      { x: 8, y: 8, enemyType: "healer" },
      { x: 7, y: 9, enemyType: "healer" },
      { x: 2, y: 11, enemyType: "zombie_fast" },
      { x: 12, y: 11, enemyType: "zombie_fast" },
      { x: 3, y: 11, enemyType: "zombie_fast" },
      { x: 11, y: 11, enemyType: "zombie_fast" },
      { x: 4, y: 13, enemyType: "zombie_fast" },
      { x: 10, y: 13, enemyType: "zombie_fast" },
      { x: 3, y: 1, enemyType: "bull" },
      { x: 11, y: 1, enemyType: "bull" },
      { x: 2, y: 9, enemyType: "bull" },
      { x: 12, y: 9, enemyType: "bull" }
    ]
  },
  {
    ...
    layout: [
      ...
      "#..###...###..#", // 2
      "#..#P#...#P#..#", // 3
      "#..#.#...#.#..#", // 4  -- broke bottom wall of top boxes (replaced ### with #.#)
      "#.............#", // 5
      "#....#####....#", // 6
      "#....#...#....#", // 7
      "#....##.##....#", // 8
      "#.............#", // 9
      "#..#.#...#.#..#", // 10 -- broke top wall of bottom boxes
      "#..#P#...#P#..#", // 11
      "#..###...###..#", // 12
      "#.............#", // 13
      "###############"  // 14
    ...
    spawnPoints: [
      ...
      // Added Horde
      { x: 2, y: 1, enemyType: "bullet_hell" },
      { x: 12, y: 1, enemyType: "bullet_hell" },
      { x: 4, y: 3, enemyType: "artificer" },
      { x: 10, y: 3, enemyType: "artificer" },
      { x: 5, y: 5, enemyType: "artificer" },
      { x: 9, y: 5, enemyType: "prefire_sentinel" },
      { x: 3, y: 7, enemyType: "prefire_sentinel" },
      { x: 11, y: 7, enemyType: "prefire_sentinel" },
      { x: 5, y: 9, enemyType: "healer" },
      { x: 9, y: 9, enemyType: "healer" },
      { x: 2, y: 13, enemyType: "zombie_fast" },
      { x: 12, y: 13, enemyType: "zombie_fast" },
      { x: 4, y: 13, enemyType: "zombie_fast" },
      { x: 10, y: 13, enemyType: "zombie_fast" },
      { x: 6, y: 13, enemyType: "zombie_fast" }
    ]
  },
  {
    ...
    spawnPoints: [
      ...
      { x: 7, y: 1, enemyType: "bull" },
      // Added Horde
      { x: 6, y: 5, enemyType: "swarm_coordinator" },
      { x: 8, y: 5, enemyType: "swarm_coordinator" },
      { x: 4, y: 5, enemyType: "healer" },
      { x: 10, y: 5, enemyType: "healer" },
      { x: 2, y: 2, enemyType: "zombie_fast" },
      { x: 12, y: 2, enemyType: "zombie_fast" },
      { x: 4, y: 2, enemyType: "zombie_fast" },
      { x: 10, y: 2, enemyType: "zombie_fast" },
      { x: 2, y: 12, enemyType: "zombie_fast" },
      { x: 12, y: 12, enemyType: "zombie_fast" },
      { x: 4, y: 12, enemyType: "zombie_fast" },
      { x: 10, y: 12, enemyType: "zombie_fast" },
      { x: 3, y: 5, enemyType: "zombie_fast" },
      { x: 11, y: 5, enemyType: "zombie_fast" },
      { x: 5, y: 9, enemyType: "zombie_basic" },
      { x: 9, y: 9, enemyType: "zombie_basic" },
      { x: 6, y: 9, enemyType: "zombie_basic" },
      { x: 8, y: 9, enemyType: "zombie_basic" },
  ...
  },
  {
    ...
    spawnPoints: [
      ...
      // Added Horde
      { x: 1, y: 2, enemyType: "prefire_sentinel" },
      { x: 13, y: 2, enemyType: "prefire_sentinel" },
      { x: 1, y: 12, enemyType: "mage_missile" },
      { x: 13, y: 12, enemyType: "mage_missile" },
      { x: 6, y: 5, enemyType: "healer" },
      { x: 8, y: 5, enemyType: "healer" },
      { x: 6, y: 1, enemyType: "jumper" },
      { x: 8, y: 1, enemyType: "jumper" },
      { x: 7, y: 2, enemyType: "jumper" },
      { x: 3, y: 5, enemyType: "zombie_fast" },
      { x: 11, y: 5, enemyType: "zombie_fast" },
      { x: 4, y: 5, enemyType: "zombie_fast" },
      { x: 10, y: 5, enemyType: "zombie_fast" }
    ]
  },
  {
    ...
    spawnPoints: [
      ...
      // Added Horde
      { x: 5, y: 6, enemyType: "jumper" },
      { x: 9, y: 6, enemyType: "jumper" },
      { x: 7, y: 6, enemyType: "jumper" },
      { x: 5, y: 4, enemyType: "jumper" },
      { x: 9, y: 4, enemyType: "jumper" },
      { x: 4, y: 3, enemyType: "healer" },
      { x: 10, y: 3, enemyType: "healer" },
      { x: 2, y: 3, enemyType: "zombie_fast" },
      { x: 12, y: 3, enemyType: "zombie_fast" },
      { x: 4, y: 7, enemyType: "zombie_fast" },
      { x: 10, y: 7, enemyType: "zombie_fast" },
      { x: 2, y: 7, enemyType: "zombie_fast" },
      { x: 12, y: 7, enemyType: "zombie_fast" },
      { x: 5, y: 9, enemyType: "artificer" },
      { x: 9, y: 9, enemyType: "artificer" },
      { x: 6, y: 1, enemyType: "bull" },
      { x: 8, y: 1, enemyType: "bull" }
    ]
  },
  {
    ...
    spawnPoints: [
      ...
      { x: 7, y: 11, enemyType: "bull" },
      // Added Horde
      { x: 5, y: 5, enemyType: "strategist" },
      { x: 9, y: 5, enemyType: "strategist" },
      { x: 6, y: 5, enemyType: "strategist" },
      { x: 8, y: 5, enemyType: "strategist" },
      { x: 4, y: 3, enemyType: "bullet_hell" },
      { x: 10, y: 3, enemyType: "bullet_hell" },
      { x: 5, y: 3, enemyType: "bullet_hell" },
      { x: 6, y: 3, enemyType: "healer" },
      { x: 8, y: 3, enemyType: "healer" },
      { x: 1, y: 9, enemyType: "zombie_fast" },
      { x: 13, y: 9, enemyType: "zombie_fast" },
      { x: 3, y: 9, enemyType: "zombie_fast" },
      { x: 11, y: 9, enemyType: "zombie_fast" },
      { x: 5, y: 9, enemyType: "zombie_fast" },
      { x: 9, y: 9, enemyType: "zombie_fast" },
      { x: 6, y: 11, enemyType: "bull" },
      { x: 8, y: 11, enemyType: "bull" }
    ]
  },
  {
    ...
    spawnPoints: [
      ...
      // Added Horde
      { x: 3, y: 3, enemyType: "artificer" },
      { x: 11, y: 3, enemyType: "artificer" },
      { x: 5, y: 3, enemyType: "artificer" },
      { x: 9, y: 3, enemyType: "artificer" },
      { x: 6, y: 3, enemyType: "artificer" },
      { x: 8, y: 3, enemyType: "artificer" },
      { x: 4, y: 7, enemyType: "bullet_hell" },
      { x: 10, y: 7, enemyType: "bullet_hell" },
      { x: 5, y: 7, enemyType: "bullet_hell" },
      { x: 9, y: 7, enemyType: "bullet_hell" },
      { x: 6, y: 7, enemyType: "healer" },
      { x: 8, y: 7, enemyType: "healer" },
      { x: 6, y: 11, enemyType: "healer" },
      { x: 1, y: 11, enemyType: "zombie_fast" },
      { x: 13, y: 11, enemyType: "zombie_fast" },
      { x: 3, y: 11, enemyType: "zombie_fast" },
      { x: 11, y: 11, enemyType: "zombie_fast" },
      { x: 6, y: 13, enemyType: "bull" },
      { x: 8, y: 13, enemyType: "bull" },
      { x: 5, y: 13, enemyType: "bull" },
      { x: 9, y: 13, enemyType: "bull" }
    ]
  },
  {
    ...
    spawnPoints: [
      ...
      { x: 7, y: 1, enemyType: "bull" },
      // Added Horde
      { x: 6, y: 5, enemyType: "prefire_sentinel" },
      { x: 8, y: 5, enemyType: "prefire_sentinel" },
      { x: 5, y: 3, enemyType: "prefire_sentinel" },
      { x: 9, y: 3, enemyType: "prefire_sentinel" },
      { x: 6, y: 3, enemyType: "bullet_hell" },
      { x: 8, y: 3, enemyType: "bullet_hell" },
      { x: 6, y: 7, enemyType: "artificer" },
      { x: 8, y: 7, enemyType: "artificer" },
      { x: 6, y: 9, enemyType: "healer" },
      { x: 8, y: 9, enemyType: "healer" },
      { x: 1, y: 11, enemyType: "zombie_fast" },
      { x: 13, y: 11, enemyType: "zombie_fast" },
      { x: 3, y: 11, enemyType: "zombie_fast" },
      { x: 11, y: 11, enemyType: "zombie_fast" },
      { x: 4, y: 11, enemyType: "zombie_fast" },
      { x: 10, y: 11, enemyType: "zombie_fast" },
      { x: 6, y: 1, enemyType: "bull" },
      { x: 8, y: 1, enemyType: "bull" }
    ]
  }
...
console.log('\n=== 10 EXTREME HORDE ROOMS SUCCESSFULLY GENERATED AND SAVED ===');
